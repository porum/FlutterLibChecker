...
with open(log_file_path, 'w') as f:
    f.write('release_date,channel,version,dart_sdk_version,engine_commit,snapshot_hash\n')
...
for data in get(release_url).json()['releases']:
    ...
    if data['snapshot_hash'] is not None:
        log_data = '{},{},{},{},{},{}\n'.format(data['release_date'], data['channel'], data['version'], data.setdefault('dart_sdk_version'), data['engine_commit'], data['snapshot_hash'])
        log_file(log_data)
        print(log_data)
